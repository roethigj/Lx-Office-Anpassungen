...
sub save {
  ...
  my $q_item =
    qq|INSERT INTO delivery_order_items (
         ...
         lastcost, price_factor_id, price_factor, marge_price_factor, tradediscount, pricegroup_id)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
...
sub retrieve {
  ...
  $query =
    qq|SELECT doi.id AS delivery_order_items_id,
         ...
         doi.price_factor_id, doi.price_factor, doi.marge_price_factor, doi.tradediscount, doi.pricegroup_id,
